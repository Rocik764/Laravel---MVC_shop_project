        ...
        <div id="content-main">
            ...
            <form action="{{ route('edit_name') }}" method="post">
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        {{ csrf_field() }}
                        <button class="btn btn-outline-secondary" type="submit" id="btnSaveName" disabled>Save</button>
                        <button class="btn btn-outline-secondary" type="button" id="btnEditName"><span>Edit</span></button>
                    </div>
            ...
            <form action="{{ route('edit_email') }}" method="post">
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        {{ csrf_field() }}
                        <button class="btn btn-outline-secondary" type="submit" id="btnSaveMail" disabled>Save</button>
                        <button class="btn btn-outline-secondary" type="button" id="btnEditMail"><span>Edit</span></button>
                    </div>
            ...
            <form action="{{ route('edit_password') }}" method="post">
                <div class="input-group mb-3">
                    <div class="input-group-prepend">
                        {{ csrf_field() }}
                        <button class="btn btn-outline-secondary" type="submit" id="btnSavePassword" disabled>Save</button>
                        <button class="btn btn-outline-secondary" type="button" id="btnEditPassword"><span>Edit</span></button>
                    </div>
                    <input type="password" name="password" class="form-control" placeholder="New password" readonly="readonly">
                </div>
            </form>
        </div>
    </div>
    ...
    $(document).ready(function() {
        $('#btnEditMail').click(function() {
            if($("#btnSaveMail").is(":disabled")) {
                ...
                $("#btnEditMail span").text("Cancel")
            } else {
                $("input[name='email']").prop("readonly", true)
                $("#btnSaveMail").prop("disabled", true)
                $("#btnEditMail span").text("Edit")
            }
        })
    })
    $(document).ready(function() {
        $('#btnEditName').click(function() {
            if($("#btnSaveName").is(":disabled")) {
                ...
                $("#btnEditName span").text("Cancel")
            } else {
                $("input[name='name']").prop("readonly", true)
                $("#btnSaveName").prop("disabled", true)
                $("#btnEditName span").text("Edit")
            }
        })
    })
    $(document).ready(function() {
