...
{{--                            <div class="row border rounded" th:with="product = ${item.product}" th:id="'row' + ${status.count}">--}}
                            <div class="row border rounded" id="<?php echo 'row'?>">
                                <div class="col-lg-1">
...
{{--                                        <div th:replace="/fragments/amount_control :: amount_control(${item.amount}, ${item.product.id})">Ilość</div>--}}
                                    ...
                                    <div>
                                        <span>=&nbsp;</span><span class="h4 productSubtotal" id="<?php echo 'subtotal'.$item->product->id?>">[[${item.subtotal}]]</span><span class="h4">&nbsp;zł</span>
                                    </div>
                                </div>
                            </div>
