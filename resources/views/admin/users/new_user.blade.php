...
<body>
@include('admin.users.resources.views.fragments.animated')
<header>
    @include('admin.users.resources.views.fragments.menu')
</header>
<div class="wrapper">
    <nav id="sidebar">
        @include('admin.users.resources.views.fragments.side_menu')
    </nav>
