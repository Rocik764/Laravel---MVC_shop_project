                                ...
                                <li>
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="input-group-prepend">
                                            <a class="float-left btn btn-danger" href="{{ route('deleteCategory', ['id' => $category->id]) }}" >Remove</a>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
                            ...
                            @foreach($subcategories as $subcategory)
                                <li>
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="input-group-prepend">
                                            <a class="float-left btn btn-danger" href="{{ route('deleteSubcategory', ['id' => $subcategory->id]) }}" >Remove</a>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
                            ...
                            @foreach($producents as $producent)
                                <li>
                                    <div class="input-group mb-3">
                                        ...
                                        <div class="input-group-prepend">
                                            <a class="float-left btn btn-danger" href="{{ route('deleteProducent', ['id' => $producent->id]) }}" >Remove</a>
                                        </div>
                                    </div>
                                </li>
                            @endforeach
